...
-- 15. 最終システムヘルスチェック
\echo '15. 最終システムヘルスチェック...'
SELECT * FROM defense_system_health_check();

-- 16. セキュリティ監査ログ確認
\echo '16. セキュリティ監査ログ確認...'
SELECT 
    action_type,
    table_name,
    security_level,
...
\echo '=== 防衛省ロジスティクス基盤テスト完了 ==='
\echo 'すべての機能が正常に動作していることを確認しました。' 