...
-- 1. 修正された輸送オーダー作成機能のテスト
SELECT '=== 修正された輸送オーダー作成テスト ===' as test_phase;
...
-- 2. 修正されたパフォーマンス監視機能のテスト
SELECT '=== 修正されたパフォーマンス監視テスト ===' as test_phase;

SELECT * FROM monitor_system_performance();

-- 3. 修正された監査ログ表示機能のテスト
SELECT '=== 修正された監査ログ表示テスト ===' as test_phase;

SELECT * FROM show_recent_audit_logs(5);

-- 4. 輸送追跡機能のテスト
SELECT '=== 輸送追跡機能テスト ===' as test_phase;
...
-- 6. システム健全性最終確認
SELECT '=== システム健全性最終確認 ===' as test_phase;
