...
BEGIN
    ...
    -- 結果を返す（タイムスタンプ型を統一）
    RETURN QUERY
    SELECT 'active_users'::VARCHAR(50), v_user_count::NUMERIC, 'count'::VARCHAR(20), (CURRENT_TIMESTAMP AT TIME ZONE 'UTC')::TIMESTAMP WITHOUT TIME ZONE
    UNION ALL
    SELECT 'total_materials'::VARCHAR(50), v_material_count::NUMERIC, 'count'::VARCHAR(20), (CURRENT_TIMESTAMP AT TIME ZONE 'UTC')::TIMESTAMP WITHOUT TIME ZONE
    UNION ALL
    SELECT 'active_orders'::VARCHAR(50), v_order_count::NUMERIC, 'count'::VARCHAR(20), (CURRENT_TIMESTAMP AT TIME ZONE 'UTC')::TIMESTAMP WITHOUT TIME ZONE
    UNION ALL
    SELECT 'active_incidents'::VARCHAR(50), v_incident_count::NUMERIC, 'count'::VARCHAR(20), (CURRENT_TIMESTAMP AT TIME ZONE 'UTC')::TIMESTAMP WITHOUT TIME ZONE;
